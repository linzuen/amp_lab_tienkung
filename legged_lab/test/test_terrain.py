...
from legged_lab.assets.tienkung2_lite import TIENKUNG2LITE_CFG  # isort: skip
from legged_lab.assets.atom_p3 import ATOM_P3_CFG
from legged_lab.terrains.ray_caster_cfg import RayCasterCfg
from legged_lab.terrains.terrain_generator_cfg import ROUGH_TERRAINS_CFG
...
class TerrainSceneCfg(InteractiveSceneCfg):
    ...
    # robot
    robot: ArticulationCfg = ATOM_P3_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
