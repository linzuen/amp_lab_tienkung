    ...
    undesired_contacts = RewTerm(
        ...
        params={
            "sensor_cfg": SceneEntityCfg(
                "contact_sensor", body_names=[".*_knee_link", ".*_shoulder_roll_link", ".*_elbow_link", "pelvis"]
            ),
            "threshold": 1.0,
        },
    )
...
@configclass
class AtomWalkFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/tienkung/datasets/motion_visualization/motion.txt"]
    device: str = "cuda:0"
...
MOTION_FILES = glob.glob("legged_lab/envs/atom/datasets/motion_amp_expert/*")
@configclass
class AtomWalkAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
