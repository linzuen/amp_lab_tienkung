...
from legged_lab.envs.atom.walk_cfg import AtomWalkFlatEnvCfg
...
class AtomEnv(VecEnv):
    ...
    def init_buffers(self):
        ...
        self.hand_body_ids, _ = self.robot.find_bodies(
        ...
        self.waist_yaw_joint_ids, _ = self.robot.find_joints(
    ...
    def visualize_motion(self, time):
        ...
        dof_vel[:, self.waist_yaw_joint_ids] = visual_motion_frame[19]
        ...
        dof_vel[:, self.waist_yaw_joint_ids] = visual_motion_frame[51]
        ...
        self.waist_yaw_dof_pos = dof_pos[:, self.waist_yaw_joint_ids]
        self.waist_yaw_dof_vel = dof_vel[:, self.waist_yaw_joint_ids]
    ...
    def get_amp_obs_for_expert_trans(self):
        ...
        self.waist_yaw_dof_pos = self.robot.data.joint_pos[:, self.waist_yaw_joint_ids]
        ...
        self.waist_yaw_dof_vel = self.robot.data.joint_vel[:, self.waist_yaw_joint_ids]
